...
public class PaymentMethodRepositoryIntegrationTestBase {
	...
	public void setup() throws Exception {
		...
		try {
			...
			paymentMethod = paymentMethodTestDataFactory
	...
	public void findById() {
		PaymentMethod temp = paymentMethodRepository.findOne(paymentMethod
				.getId());
	...
	public void testEdit() throws IllegalAccessException,
		...
		BeanUtils.copyProperties(paymentMethod,
				paymentMethodTestDataFactory.createPaymentMethodTwo());
